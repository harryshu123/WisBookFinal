...
public class Main extends Application {
    ...
    Scene secondScene(Person text1,Stage primaryStage,Scene scene) {
        ...
        HB.setStyle("-fx-background-color: #7fff00");
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        EventHandler<ActionEvent> event1 = new EventHandler<ActionEvent>() {
            ...
            {     BorderPane root1= new BorderPane();
                ...
                Scene secondS = new Scene(root1,WINDOW_WIDTH, WINDOW_HEIGHT,Color.BEIGE);
                if(p1==null) {
        ...
        heading.setFont(Font.font(java.awt.Font.SERIF, 25));
        Text  heading2 =new Text("\nAdd/Remove the Relationships\n");
        heading2.setFont(Font.font(java.awt.Font.SERIF, 18));
